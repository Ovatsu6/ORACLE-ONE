...
empleado.asignarClave('12345');//valida tipo de usuario por su clave asignada
console.log(SistemaAutenticacion.login(empleado,'12345'));

const gerente = new Gerente('Pedro Rivas','232344',12000);
gerente.asignarClave('655');//valida tipo de usuario por su clave asignada
console.log(SistemaAutenticacion.login(gerente,'655'));

//const director = new Director('Elena Moreno','232323',15000);

const cliente = new Cliente('Leonardo','13804050','123224');
cliente.asignarClave('01111');//valida tipo de usuario por su clave asignada
console.log(SistemaAutenticacion.login(cliente,'01111'));

//cuentaDeLeonardo.prueba1();
